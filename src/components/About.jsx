//In this page provide the information about the project
import React from 'react'
export const About = () => {
  return (
    <div 
    >
        <div className='d-flex justify-content-center fs-1 bg-success text-light p-5 m-5'>
            <h1 className='fs-1 font-weight-bold' 
>About</h1>
        </div>
